...
public interface Service {
    TranslationsPackage getPackage(String packageId);

    Integer getPackageVersion(String packageId);

    Success updatePackage(TranslationsPackage translationsPackage);
}
